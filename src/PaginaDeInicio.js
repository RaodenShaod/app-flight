  ...
  <div>
    ...
    <form action="" method="">
     ...
     <label htmlFor="ida">Ida</label>
      <input type="radio" name="viaje" id="ida" value="Ida" checked ></input>
 
      <label htmlFor="idaYVuelta">Ida y vuelta</label>
      <input type="radio" name="viaje" id="idaYVuelta" value="IdaYVuelta"  onClick={this.idayVueltaRadioButton}></input>
...
idayVueltaRadioButton(){
    this.setState({
      FormularioDeVuelos: <div> <h2>Vuelos Online</h2> 
      <h3>Encuentra tus pasajes Aqui</h3>
      ...
      <form action="" method="">
       ...
       <label htmlFor="ida">Ida</label>
        <input type="radio" name="viaje" id="ida" value="Ida" onClick={this.idaRadioButton}  ></input>
   
        <label htmlFor="idaYVuelta">Ida y vuelta</label>
        <input type="radio" name="viaje" id="idaYVuelta" value="IdaYVuelta"checked></input>
       ...
       <input type="text" placeholder="Ciudad Destino" id="regreso"></input>
